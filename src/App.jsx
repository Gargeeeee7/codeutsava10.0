...
class ErrorBoundary extends Component {
  ...
  render() {
    if (this.state.error) {
      return (
        <div style={{ minHeight: "100vh", background: "#1a1010", color: "#f5e6e6", padding: 32, fontFamily: "ui-monospace, monospace", whiteSpace: "pre-wrap" }}>
          <h1 style={{ color: "#e11d48", marginTop: 0 }}>Something crashed</h1>
          <pre style={{ background: "#0a0807", padding: 16, borderRadius: 8, border: "1px solid #7a1420", overflow: "auto" }}>
...
export default function App() {
  ...
  return (
    <ErrorBoundary>
      <div style={{ position: "relative", minHeight: "100vh", background: "#0a0807", color: "#e7e5e4" }}>
        <Background />
